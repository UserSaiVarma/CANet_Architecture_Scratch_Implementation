...
###################################################################################################################
def architecture(image_shape, classes):
    "Total Architecture"
    ...
    final_conv = Conv2D(filters=classes, kernel_size=(3,3), strides=(1,1), padding='same', name='final_conv')(concat)
...
def CANet():
    ...
    input, output = architecture(image_shape=(128,128,3), classes=21)
